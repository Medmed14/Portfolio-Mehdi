...
const Contact = () => {
    ...
    return (
        <>
            <div id="contact" className="container-fluid p-5">
                <h1 className="contact-heading">Contact</h1>
                <p className="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-4 offset-lg-2">N'hesitez pas à me contacter, je vous répondrais dans les meilleurs délais.</p>
                <div className="row">
