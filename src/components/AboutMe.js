                ...
                <div className="row">
                    <div className="col-lg-6 col-xm-12">
                        <div className="photo-wrap">
                            <img className="profile" src={author} alt="photo de Mehdi" />
                        </div>
                    </div>
                    <div className="col-lg-6 col-xm-12">
                        <h1 className="about-heading mb-3"> Qui suis-je ?</h1>
                        <p>Je me présente, je m'appelle Mehdi. Je suis passionné depuis très jeune par l'informatique, mais ça a toujours été une "passion loisir". J'ai eu l'envie
                            ...
                            suivi d'un stage de deux mois dans une agence Parisienne.
                            Ce qui me plaît par dessus tout dans ce métier c'est le progrès quotidien. On en apprend tous les jours et j'adore ça.
                            Je suis actuellement développeur à plein temps chez Castel Frères, grande entreprise des vins et spiritueux.
                        </p>
                    </div>
                </div>
            </div>
